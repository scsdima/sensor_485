...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/sensor_485.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=src/drivers/delay.c src/drivers/mma8450.c src/drivers/sysclk.c src/drivers/sw_i2c.c src/drivers/uart.c src/drivers/eeprom.c src/drivers/adc.c src/modules/rd_buffer.c src/modules/timers.c src/modules/device_config.c src/modules/scheduler.c src/modules/serialport.c src/modules/string_utils.c src/modules/syntax.c src/modules/classic_detector.c src/modules/peak_detector.c src/modules/detection.c src/modules/on_parameter_found.c src/startup/startup.c src/interrupts.c src/main.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/src/drivers/delay.p1 ${OBJECTDIR}/src/drivers/mma8450.p1 ${OBJECTDIR}/src/drivers/sysclk.p1 ${OBJECTDIR}/src/drivers/sw_i2c.p1 ${OBJECTDIR}/src/drivers/uart.p1 ${OBJECTDIR}/src/drivers/eeprom.p1 ${OBJECTDIR}/src/drivers/adc.p1 ${OBJECTDIR}/src/modules/rd_buffer.p1 ${OBJECTDIR}/src/modules/timers.p1 ${OBJECTDIR}/src/modules/device_config.p1 ${OBJECTDIR}/src/modules/scheduler.p1 ${OBJECTDIR}/src/modules/serialport.p1 ${OBJECTDIR}/src/modules/string_utils.p1 ${OBJECTDIR}/src/modules/syntax.p1 ${OBJECTDIR}/src/modules/classic_detector.p1 ${OBJECTDIR}/src/modules/peak_detector.p1 ${OBJECTDIR}/src/modules/detection.p1 ${OBJECTDIR}/src/modules/on_parameter_found.p1 ${OBJECTDIR}/src/startup/startup.p1 ${OBJECTDIR}/src/interrupts.p1 ${OBJECTDIR}/src/main.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/src/drivers/delay.p1.d ${OBJECTDIR}/src/drivers/mma8450.p1.d ${OBJECTDIR}/src/drivers/sysclk.p1.d ${OBJECTDIR}/src/drivers/sw_i2c.p1.d ${OBJECTDIR}/src/drivers/uart.p1.d ${OBJECTDIR}/src/drivers/eeprom.p1.d ${OBJECTDIR}/src/drivers/adc.p1.d ${OBJECTDIR}/src/modules/rd_buffer.p1.d ${OBJECTDIR}/src/modules/timers.p1.d ${OBJECTDIR}/src/modules/device_config.p1.d ${OBJECTDIR}/src/modules/scheduler.p1.d ${OBJECTDIR}/src/modules/serialport.p1.d ${OBJECTDIR}/src/modules/string_utils.p1.d ${OBJECTDIR}/src/modules/syntax.p1.d ${OBJECTDIR}/src/modules/classic_detector.p1.d ${OBJECTDIR}/src/modules/peak_detector.p1.d ${OBJECTDIR}/src/modules/detection.p1.d ${OBJECTDIR}/src/modules/on_parameter_found.p1.d ${OBJECTDIR}/src/startup/startup.p1.d ${OBJECTDIR}/src/interrupts.p1.d ${OBJECTDIR}/src/main.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/src/drivers/delay.p1 ${OBJECTDIR}/src/drivers/mma8450.p1 ${OBJECTDIR}/src/drivers/sysclk.p1 ${OBJECTDIR}/src/drivers/sw_i2c.p1 ${OBJECTDIR}/src/drivers/uart.p1 ${OBJECTDIR}/src/drivers/eeprom.p1 ${OBJECTDIR}/src/drivers/adc.p1 ${OBJECTDIR}/src/modules/rd_buffer.p1 ${OBJECTDIR}/src/modules/timers.p1 ${OBJECTDIR}/src/modules/device_config.p1 ${OBJECTDIR}/src/modules/scheduler.p1 ${OBJECTDIR}/src/modules/serialport.p1 ${OBJECTDIR}/src/modules/string_utils.p1 ${OBJECTDIR}/src/modules/syntax.p1 ${OBJECTDIR}/src/modules/classic_detector.p1 ${OBJECTDIR}/src/modules/peak_detector.p1 ${OBJECTDIR}/src/modules/detection.p1 ${OBJECTDIR}/src/modules/on_parameter_found.p1 ${OBJECTDIR}/src/startup/startup.p1 ${OBJECTDIR}/src/interrupts.p1 ${OBJECTDIR}/src/main.p1

# Source Files
SOURCEFILES=src/drivers/delay.c src/drivers/mma8450.c src/drivers/sysclk.c src/drivers/sw_i2c.c src/drivers/uart.c src/drivers/eeprom.c src/drivers/adc.c src/modules/rd_buffer.c src/modules/timers.c src/modules/device_config.c src/modules/scheduler.c src/modules/serialport.c src/modules/string_utils.c src/modules/syntax.c src/modules/classic_detector.c src/modules/peak_detector.c src/modules/detection.c src/modules/on_parameter_found.c src/startup/startup.c src/interrupts.c src/main.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/sensor_485.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/sensor_485.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/sensor_485.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=pro -P -N255 -I"src" -I"src/init" -I"src/drivers" -I"src/startup" -I"src/modules" --warn=0 --asmlist --summary=default,-psect,-class,+mem,+hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     --rom=default,-7dc0-7fff --ram=default,-5f4-5ff,-f9c-f9c,-fd4-fd4,-fdb-fdf,-fe3-fe7,-feb-fef,-ffd-fff --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/sensor_485.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/sensor_485.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/sensor_485.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/sensor_485.${IMAGE_TYPE}.map  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=pro -P -N255 -I"src" -I"src/init" -I"src/drivers" -I"src/startup" -I"src/modules" --warn=0 --asmlist --summary=default,-psect,-class,+mem,+hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/sensor_485.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
